...
map.getView().fit([1052074.520112, 5748131.392450, 1067202.921486, 5756479.254846], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Progetto 4x4</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (140 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Proposta di nuovo sistema di linee di trasporto a chiamata per una circolazione libera, flessibile e inclusiva nei Comuni della Valle Imagna';
            }
